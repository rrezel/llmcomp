...
- **Muse (Llama-4 Maverick):** 2 match points, 0-2-7, 2 game wins, 0 captures. Same crash-on-protocol pattern as Grok/Nemotron; 16 timeouts. (No "Muse Spark" model on OpenRouter, so Llama-4 Maverick was used as the closest current Meta model.)
